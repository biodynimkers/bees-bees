        ...
        <div className="container container--narrow">
          <div className="grid grid--2" style={{ gap: 'var(--space-12)' }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 'var(--space-10)' }}>
              ...
              <div className="card" style={{ padding: 'var(--space-10)' }}>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 'var(--space-6)' }}>
                  <div>
                    ...
                    <Link href={`/hives/${observation.hive.id}`} style={{ 
                      fontFamily: "var(--font-display)",
                      fontSize: "1.125rem",
                  ...
                  <div>
                    ...
                    <Link href={`/apiaries/${observation.hive.apiary.id}`} style={{ 
                      fontFamily: "var(--font-display)",
                      fontSize: "1.125rem",
                      color: "var(--color-text)",
                      textDecoration: "underline",
              ...
              {observation.notes && (
                <div className="card" style={{ padding: 'var(--space-10)' }}>
                  <div style={{ display: "flex", gap: "var(--space-3)", marginBottom: "var(--space-6)", paddingBottom: "var(--space-4)", borderBottom: "1px solid rgba(0, 0, 0, 0.06)" }}>
